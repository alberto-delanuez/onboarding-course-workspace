...
export const AuthRepositoryToken = new DIToken<AuthRepository>(
    'AuthRepository'
);
export const LoginUseCaseToken = new DIToken<LoginUseCase>('LoginUseCase');
export const RegisterUseCaseToken = new DIToken<RegisterUseCase>(
    'RegisterUseCase'
);
export const VerifyUseCaseToken = new DIToken<VerifyUseCase>('VerifyUseCase');
export const SocialLoginUseCaseToken = new DIToken<SocialLoginUseCase>(
    'SocialLoginUseCase'
);
export const RequestOtpUseCaseToken = new DIToken<RequestOtpUseCase>(
    'RequestOtpUseCase'
);
export const LoginWithOtpUseCaseToken = new DIToken<LoginWithOtpUseCase>(
    'LoginWithOtpUseCase'
);
